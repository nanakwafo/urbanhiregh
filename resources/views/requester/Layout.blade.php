              ...
              <div class="col-sm-8 col-md-7 col-lg mg-t-20 mg-sm-t-0 mg-lg-t-25">
               ...
               <label class="tx-sans tx-10 tx-semibold tx-uppercase tx-color-01 tx-spacing-1 mg-b-15">Contact Information</label>
                <ul class="list-unstyled profile-info-list">
                  ...
                  <li><i data-feather="home"></i> <span class="tx-color-03">{{ $item->address }}</span></li>
...
@include('shared.navbar')
 ...
 <nav class="navbar navbar-expand-lg navbar-light bg-light bd">
            <a class="navbar-brand tx-bold tx-spacing--2 order-1" href="#"><h6 class="tx-uppercase tx-semibold mg-b-0">@yield('pagename')</h6></a>
