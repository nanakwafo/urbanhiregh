...
<!-- <button type="submit" class="btn btn-primary">Add New</button> -->
        ...
        <a href="/requester-add-property/{{$userId}}" class="btn btn-xs btn-primary ">Add Property</a><br><br>
          <table id="example2" class="table">
            ...
            <tbody>
              ...
              <tr>
                <td>
    <img src="{{ asset($item->property_image) }}" class="img wd-60 ht-60 rounded-circle" alt="Property Image">
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
   <a class="dropdown-item" href="requester-edit-property/{{ $item->id }}">Edit</a>
     ...
     <a href="#modal6Property{{ $item->id }}" class="dropdown-item btn-delete" data-id="{{ $item->id }}" data-toggle="modal" data-animation="effect-sign">Delete</a>
  ...
  <div class="modal fade" id="modal6Property{{ $item->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel6" aria-hidden="true">
