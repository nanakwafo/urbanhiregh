...
{{--                    <li class="nav-sub-item"><a href="/completed_jobs/{{$userId}}" class="nav-sub-link"><i data-feather="calendar"></i>Completed</a></li>--}}
{{--                    <li class="nav-sub-item"><a href="/available_jobs/{{$userId}}" class="nav-sub-link"><i data-feather="message-square"></i>Available</a></li>--}}
