<header class="navbar navbar-header navbar-header-fixed bd-b-0">
    ...
    <div id="navbarMenu" class="navbar-menu-wrapper">
        ...
        <ul class="nav navbar-menu">
            ...
            <li class="nav-item with-sub">
                <a href="#" class="nav-link"><i data-feather="package"></i> What you get</a>
                <ul class="navbar-menu-sub">
            ...
            <li class="nav-item with-sub">
                <a href="" class="nav-link"><i data-feather="layers"></i> Your reputation</a>
            ...
            <li class="nav-item"><a href="components/" class="nav-link"><i data-feather="box"></i> Your Benefits</a></li>
            <li class="nav-item"><a href="collections/" class="nav-link"><i data-feather="archive"></i> Trades like you</a></li>
        </ul>
    </div><!-- navbar-menu-wrapper -->
    <div class="navbar-right">

        <a href="https://themeforest.net/item/dashforge-responsive-admin-dashboard-template/23725961" class="btn btn-buy"><i data-feather="phone-call"></i> <span>Call Now on 0598296977</span></a>
    </div><!-- navbar-right -->
</header><!-- navbar -->
